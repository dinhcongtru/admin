  ...
  <div class="card">
    ...
    <div class="p-3 card-body">
      <ul class="list-group" :class="this.$store.state.isRTL ? 'pe-0' : ''">
        <li v-for="(product,index) in listProBestSell" :key="index"
        ...
        >
          <div class="d-flex align-items-center">
            ...
            <div class="d-flex flex-column">
              <h6 class="mb-1 text-sm text-dark">{{ product.productName }}</h6>
              <span class="text-xs">
                {{ product.quantity }} Tổng Số Hàng Tồn Kho
              </span>
            </div>
          </div>
          <div class="d-flex">
      ...
      default: () => [
        {
          ...
          quantity: 30,
          url: "https://ik.imagekit.io/mbtxd1r6m/ivancik.jpg?updatedAt=1704856505572"
        }
      ]
    },
    cardTitle: {
